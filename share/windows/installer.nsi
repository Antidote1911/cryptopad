; CryptoPad NSIS installer script
; Called from CI with:
...
!define APPNAME "CryptoPad"
!define APPEXE  "cryptopad.exe"
...
!define MUI_ICON   "cryptopad.ico"
!define MUI_UNICON "cryptopad.ico"

Name    "${APPNAME} ${APPVERSION}"
OutFile "cryptopad-${APPVERSION}-windows-setup.exe"
...
Section "Install"
    ...
    WriteRegStr HKLM "${REGKEY}" "Publisher"        "CryptoPad"
